...
public class ReservationDao {
    ...
    public Reservation bookReservation(Reservation reservation) {
        ...
        if (reservation.getTotalCost() == null) {
            reservation.setTotalCost(calculateTotalCost(
     ...
     *
     * @param costPerNight cost per night for a reservation.
     *        Taxes and other fees are already included in this cost.
